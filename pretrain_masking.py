...
def main():
    ...
    parser.add_argument('--mask_rate', type=float, default=0.20,
    ...
    parser.add_argument('--output_model_file', type=str, default = 'models/mask_e_20', help='filename to output the model')
